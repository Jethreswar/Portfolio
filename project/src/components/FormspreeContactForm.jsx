                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full py-3 pl-10 pr-4 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 ${formErrors.name ? 'border-red-500 focus:ring-red-500' : 'border-gray-600 focus:ring-blue-500'
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full py-3 pl-10 pr-4 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 ${formErrors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-600 focus:ring-blue-500'
                                        } text-white placeholder-gray-400`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full py-3 pl-10 pr-4 bg-gray-700 rounded-lg border border-gray-600 focus:outline-none focus:ring-2 ${formErrors.phone ? 'border-red-500 focus:ring-red-500' : 'focus:ring-blue-500'
                                        } text-white placeholder-gray-400`}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className={`w-full py-3 pl-10 pr-4 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 ${formErrors.message ? 'border-red-500 focus:ring-red-500' : 'border-gray-600 focus:ring-blue-500'
                                        } text-white placeholder-gray-400`}
